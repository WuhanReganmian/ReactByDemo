...
import { Input, Select, Table, Popover, Pagination, Modal, Alert, Button, message } from 'antd';
import { SearchOutlined, SettingOutlined, EnvironmentOutlined, TabletOutlined, PlusOutlined } from '@ant-design/icons';
import fetch from '@/Api';
import defaultImg from '@/Images/member_img.png';
import { useRequest } from '@umijs/hooks';

const { getHeadFieldsList, getUserDataList, getUserInfo, getAllDomainList, getAllFieldsList, changeDomainFieldsList, toChangeUserFields } = fetch;
